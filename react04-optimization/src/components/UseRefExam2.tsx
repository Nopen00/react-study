      ...
      <div className="flex flex-col gap-2 m-3">
        <form action="">
          <div>
            ...
            <input type="password" ref={passRef1} name="pass1" className="border-2 border-sky-200 outline-none focus:border-sky-700" />
          </div>
          <div>
            <label htmlFor="">패스워드2</label>
            <input type="password" ref={passRef2} name="pass2" className="border border-black" />
          </div>
          <button type="button" className="border bg-orange-300 p-3" onClick={checkPassword}>패스워드 확인</button>
        </form>
      </div>
    </div>
  );
